    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, to='est_quote.Product', null=True)),
                ('quote', models.ForeignKey(blank=True, to='est_quote.Quote', null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('glob_vars', models.ForeignKey(blank=True, to='est_quote.QuoteModifiers', null=True)),
                ('quote', models.ForeignKey(blank=True, to='est_quote.Quote', null=True)),
            ],
        ),
        migrations.AddField(
            model_name='quote',
            name='global_mods',
            field=models.ManyToManyField(related_name='quote', through='est_quote.QuoteProperties', to='est_quote.QuoteModifiers', blank=True),
        ),
        migrations.AddField(
            model_name='quote',
            name='products',
